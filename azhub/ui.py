...
<div id="win">
  ...
  <div id="body">
    ...
    <aside id="side">
      ...
      <div id="receipts"></div>
      <h2>FragGate</h2>
      <div class="cite">AI path is FragGate only. This chrome is human software. Suite mesh <code>/v1/mesh/*</code> PROXIES to aziel-runtime. Read-only Live Nodes from runtime status. QNS-CD-1.0 (photon QNS1 packet transfer) hub cite / Worker mesh cross-map only. Not a Softwares-tab product. No public qnsd proxy. Not a Node Gate. Not a publish path. AZInterface, AZBrowser, and AZNet are separate software under one FragGate door.</div>
    </aside>
  </div>
